...
<template>
  <q-footer v-bind="attrs" v-on="listeners" class="lms-layout-footer">
    ...
    <div class="lms-footer-illustration">
      <div
        class="lms-footer-illustration__waves"
        style="
          background-image: url('/statics/la-mia-salute/immagini/sfondo-footer.svg');
        "
      >
    ...
    <template v-if="rating">
      <div
        class="lms-layout-footer__rating row justify-center q-col-gutter-x-md"
      >
        <div class="col-auto">
        ...
        <router-link
          ...
          alt="Valuta questo servizio"
        >
          <div class="text-h6 text-bold" style="line-height: 1">
            Valuta questo servizio
          </div>
          <div class="text-body1 q-mt-xs">Aiutaci a migliorare</div>
        </router-link>
      </div>
    </template>
      ...
      <div class="row q-col-gutter-xl">
        ...
        <template v-if="helpContacts || helpFaq">
          ...
          <div class="col-12 col-md-auto column lms-layout-footer__help__links">
            <div class="text-h6 text-bold">Hai bisogno di aiuto?</div>
      ...
      >
        <div class="col-12 col-sm-auto">
          <a :href="urls.urlPiemonteTu()">
            <img
              src="/statics/la-mia-salute/immagini/logo-piemonte-tu.svg"
...
.lms-footer-illustration__banner
  background-image: url('../../../public/images/footer-banner.svg')
  background-repeat: no-repeat
  background-position: center top
