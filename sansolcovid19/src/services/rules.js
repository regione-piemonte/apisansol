...
import {hasValidCin} from "src/services/tax-code";
...
const PHONE_NUMBER_MOBILE_REGEX = /^[0-9]{9,10}$/;
...
export const phoneNumberMobile = v => {
  return !v || (PHONE_NUMBER_MOBILE_REGEX.test(v) && !v.startsWith("0"));
};

export const validDate = v =>  /^(0?[1-9]|[12][0-9]|3[01])[\/\-](0?[1-9]|1[012])[\/\-]\d{4}$/.test(v)


export const taxCodeCin = v => hasValidCin(v);
