...
<template>
  <q-dialog v-bind="attrs" v-on="listeners" class="fse-rol-pay-dialog">
    <q-card style="max-width: 800px">
      <q-toolbar>
        <q-toolbar-title>
          Pagamento del referto
        </q-toolbar-title>
...
export default {
  name: "FseRolPayDialog",
  inheritAttrs: false,
  props: {
    rol: { type: Object, required: false, default: () => null }
  },
  data() {
    return {};
  },
  ...
  methods: {
    onConfirm() {
      ...
      let asl = this.rol?.azienda?.codice ?? null;
