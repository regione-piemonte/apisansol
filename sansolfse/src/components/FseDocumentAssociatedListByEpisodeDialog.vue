...
<template>
  <q-dialog
    v-bind="attrs"
    v-on="listeners"
    class="fse-associate-list-by-episode-dialog"
  >
    <q-card style="max-width: 800px">
      <q-toolbar>
        <q-toolbar-title>
          Documenti associati per episodio
        </q-toolbar-title>
      ...
      <q-card-section class="q-gutter-y-md">
        <fse-document-item
          ...
          :key="'episode-association--' + document.id_documento_ilec"
          :document="document"
        />
      </q-card-section>
    </q-card>
...
export default {
  name: "FseDocumentAssociatedListByEpisodeDialog",
  inheritAttrs: false,
