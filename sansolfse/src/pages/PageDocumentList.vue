...
<template>
  <lms-page padding>
    ...
    <!-- LISTA REFERTI DA PAGARE/RITIRARE -->
    <!-- ----------------------------------------------------------------------------------------------------------- -->
    <template v-if="canSeeDocumentRolList">
      <q-expansion-item class="q-mt-lg" default-opened header-class="q-pl-none">
        <template #header>
        ...
        <div class="q-mt-md q-gutter-y-md">
          <template v-if="isLoadingRolList">
            <q-card v-for="i in 5" :key="'rol-skeleton--' + i">
              <fse-rol-item-skeleton />
            </q-card>
          </template>

          <template v-else>
            <template v-if="rolList.length <= 0">
              <fse-rol-list-empty-banner />
            </template>

            <template v-else>
              <q-card
                v-for="document in rolList"
                :key="'rol--' + document.id_documento_ilec"
              >
                <fse-rol-item
                  :document="document"
                  @withdrawn="onDocumentRolWithDrawn"
                  @image-booked="onImageBookedRol"
                />
              </q-card>
            </template>
          </template>
        ...
        >
          <template #header>
            <q-item-section class="text-bold">
              ...
              <!--            &lt;!&ndash; VISUALIZZAZIONE CONTEGGI PER EPISODIO &ndash;&gt;-->
              <!--            <template v-if="viewSelected === VIEW_MAP.EPISODE">-->
              <!--              <template v-if="episodeList && counts">-->
              <!--                ({{ episodeList.length }} episodi su-->
              <!--                {{ counts.numero_episodi }})-->
              ...
              <!--            &lt;!&ndash; VISUALIZZAZIONE CONTEGGI PER DOCUMENTO &ndash;&gt;-->
              <!--            <template v-else>-->
              <!--              <template v-if="documentList && counts">-->
              <!--                ({{ documentList.length }} documenti su-->
              <!--                {{ counts.numero_documenti_totali }})-->
...
<!--            <div class="q-mt-xs row q-col-gutter-lg" v-if="IS_PROD">-->
...
<!--                        <q-checkbox-->
<!--                          v-model="filterDocumentCategoryCodeList"-->
<!--                          :val="scope.opt.codice"-->
<!--                          dense-->
<!--                        />-->
<!--                      </q-item-section>-->
<!--                      <q-item-section>-->
<!--                        <q-item-label v-html="scope.opt.descrizione" />-->
<!--                      </q-item-section>-->
<!--                    </q-item>-->
<!--                  </template>-->
<!--                </q-select>-->
...
<!--                        &lt;!&ndash;                        v-html="&ndash;&gt;-->
<!--                        &lt;!&ndash;                          scope.opt.codice + ' - ' + scope.opt.descrizione&ndash;&gt;-->
<!--                        &lt;!&ndash;                        "&ndash;&gt;-->
<!--                        &lt;!&ndash;                      />&ndash;&gt;-->
<!--                      </q-item-section>-->
<!--                    </q-item>-->
...
<!--                  :option-value="getTagListOptionValue"-->
<!--                  :options="tagList"-->
<!--                  dense-->
<!--                  label="Etichette"-->
<!--                  multiple-->
...
<!--                      </q-item-section>-->
<!--                      <q-item-section>-->
<!--                        <q-item-label v-html="scope.opt.testo" />-->
<!--                        &lt;!&ndash;                      <q-item-label&ndash;&gt;-->
<!--                        &lt;!&ndash;                        v-html="scope.opt.id + ' - ' + scope.opt.testo"&ndash;&gt;-->
<!--                        &lt;!&ndash;                      />&ndash;&gt;-->
<!--                      </q-item-section>-->
<!--                    </q-item>-->
<!--                  </template>-->
          ...
          >
            ...
            <div class="col-12 col-sm q-gutter-x-sm">
              <q-btn
                ...
                aria-label="Visualizzazione per documenti"
              >
                <q-tooltip>
              ...
              <template v-if="$q.screen.gt.lg">
                <q-btn
                  ...
                  aria-label="Visualizzazione per sede anatomica"
                >
                  <q-tooltip>
              ...
              <q-btn
                ...
                aria-label="Visualizzazione per episodi"
              >
                <q-tooltip>
