...
<template>
  <q-btn flat dense :round="$q.screen.lt.md" no-caps icon="help" class="lms-help-button">
    ...
    >
      <q-list class="lms-help-button__menu__list" style="min-width: 120px">
        ...
        <q-item clickable @click="$emit('click-assistance')">
          <q-item-section>
            <q-item-label label>Assistenza</q-item-label>
          </q-item-section>
        </q-item>
