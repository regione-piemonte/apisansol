...
import LmsCardItemPrimary from "components/core/LmsCardItemPrimary";
import LmsCardItem from "components/core/LmsCardItem";
...
export default ({ app, router, store, Vue }) => {
  ...
  Vue.component(LmsCardItem.name, LmsCardItem);
  Vue.component(LmsCardItemPrimary.name, LmsCardItemPrimary);
};
