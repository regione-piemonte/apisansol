...
<template>
  <div class="tac-guard-notebook-hidden-to-delegator">
          ...
          <q-card class="q-my-xl">
            <q-card-section>
              <div class="row q-col-gutter-md">
                ...
                <div class="col-12 col-sm">
                  <div class="q-pa-md">
                    Il taccuino risulta oscurato. Per questo motivo non puoi visualizzarlo.
                  </div>
                </div>
              </div>
            </q-card-section>
...
export default {
  name: "TacGuardNotebookHiddenToDelegator",
  props: {},
  data() {
    return {};
  },
  computed: {
    ...
    isNotebookHiddenToDelegator() {
      return this.$store.getters["isNotebookHiddenToDelegator"];
    },
    isRouteFree() {
    ...
    isAuthorized() {
      if (this.delegatorSelected) {
        return !this.isNotebookHiddenToDelegator || this.isRouteFree;
      }
...
<style lang="scss">
.tac-guard-notebook-hidden-to-delegator__container {
  margin-left: auto;
  margin-right: auto;
  max-width: 680px;
}
