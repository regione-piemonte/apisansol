...
export const SANITARY_NOTEBOOK_MENU = {
  ...
  component: () =>
    import("pages/sanitary-notebook/PageTacSanitaryNotebookMenu.vue"),
};
...
export const DOCUMENT_DETAIL = {
  ...
  children: [REPORT_DETAIL, REPORT_IMAGES, IMAGE_DETAIL, TRANSCRIPTION],
};
//--------------------------------------------------------//
...
export const TAC_STRUCTURE_CONTACT = {
  ...
  component: () =>
    import("pages/sanitary-notebook/PageTacStructureContact.vue"),
};
...
export const SANITARY_NOTEBOOK = {
  ...
  component: () =>
    import("pages/sanitary-notebook/PageTacSanitaryNotebook.vue"),
  children: [
    TAC_DETECTIONS,
    TAC_DRUGS,
    TAC_DIET,
...
export const APP = {
  ...
  children: [QR_CODE_HOME, HOME, PATIENT],
};

export const LAYOUT_APP = {
  path: "/",
  component: () => import("layouts/LayoutApp.vue"),
  children: [APP, LCCE_HOME, ECWDME_HOME],
};
