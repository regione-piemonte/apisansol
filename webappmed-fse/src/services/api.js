...
const SECONDARY_APP_CODE = "SECONDARY_APP_CODE"
...
export const getDocumentImageDownloadUrl = (payload, httpConfig = {}) => {
  ...
  /*
  2023-07-11
  Modifica con automatica di URL sulla base dell'ambiente
  */
  let baseUrl = process.env.APP_API_BASE_URL_DMASS + "/dmasssrv/scaricoPacchettoOperatoreSanitario";
