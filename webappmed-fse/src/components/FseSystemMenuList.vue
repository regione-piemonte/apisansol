...
<template>
  <q-list ref="fseSystemMenuList">
    <q-item key="header" class="q-pa-none text-h1 text-black fse-system-item"
      >Regime</q-item
    >
    <div v-for="system in systemList" :key="system.codice" style="width: 280px">
      <q-item
      ...
      >
        ...
        <q-item-section>
          <q-item-label
            ><strong>{{ system.descrizione | upperCase }}</strong></q-item-label
          >
        </q-item-section>
      </q-item>
    </div>
