...
<template>
  <div id="fse-consents-print">
    <div class="fse-consents-print--container q-pa-xl row justify-center">
      <div
        ...
        <div class="col q-mt-lg">
          <q-card class="print-consents-fse--card" flat>
            <q-card-section class="no-padding">
              In data <strong>{{ now | date }}</strong> alle ore
              <strong>{{ now | time }}</strong
              >, l'operatore . . . . . . . . . . . . . . . . . . . . . . . . . .
              . . . .
              <br />
              ha effettuato una variazione dei consensi per l'assistito
              <strong>{{ patientFullName }}</strong> codice fiscale
              <strong>{{ patientTaxCode }}</strong
              >, nato a <strong>{{ patientBirthPlace }}</strong> il
              <strong>{{ patientBirthDate | date }}</strong
              >.
            </q-card-section>
            ...
            <q-card-section class="no-padding">
              <p>&nbsp;</p>
              <p>
                Per minori, indicare il soggetto richiedente: (nome, cognome) .
                . . . . . . . . . . . . . . . . . . . . . . . . . <br />con
                codice fiscale . . . . . . . . . . . . . . . . . . . . . . . . .
                . . . .&nbsp;
              </p>
            ...
            <q-card-section class="no-padding">
              ...
              <ol>
                <li>
                  &Egrave; stata presa visione dell&rsquo;informativa del
                  fascicolo sanitario elettronico.
                </li>
                <li>
                  &Egrave; stato dato il consenso alla consultazione del
                  fascicolo da parte di operatori
                  socio-sanitari/sanitari/amministrativi.
                </li>
              </ol>
              <p>
                Si precisa che le operazioni effettuate sono tracciate nel
                sistema del FSE e disponibili al cittadino nella sezione del
                &ldquo;Profilo&rdquo; del portale SalutePiemonte. Se sono state
                abilitate le notifiche dal cittadino, tali accessi saranno anche
                inviati secondo le preferenze impostate.
              </p>
              <p>&nbsp;</p>
