...
<template>
  ...
  >
    <q-card style="min-width: 80%">
      <q-toolbar>
        <q-toolbar-title> Medico curante </q-toolbar-title>
        <q-btn
          v-close-popup
        ...
        <csi-card-item on-side>
          <template #primary>
            ...
            <csi-card-item-primary class="relative-position q-px-lg" inline>
              ...
              <template #text>
                <div class="text-bold">Dati del medico</div>
              </template>
        ...
        <csi-card-item on-side>
          <template #primary>
            ...
            <csi-card-item-primary class="relative-position q-px-lg" inline>
              ...
              <template #text>
                <div class="text-bold">Ambulatori</div>
              </template>
            </csi-card-item-primary>
          </template>
          ...
          <template #secondary>
            <q-card-section
              class="no-padding"
              v-for="(office, index) in doctorOfficeList"
              :key="index"
            >
...
export default {
  ...
  computed: {
    ...
    doctorIcon() {
      let doctorIcon =
        this.doctor?.sesso === "F" ? "medico-donna" : "medico-uomo";
