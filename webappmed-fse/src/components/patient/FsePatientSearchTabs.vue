...
<template>
  <div class="q-pa-md">
    ...
    <q-tab-panels v-model="patientSearchTab" animated class="bg-transparent">
      ...
      <q-tab-panel :name="TABS.PIEDMONT">
                ...
                <q-form greedy @submit="onSearchPatientByAnagraphics">
                  <q-card-section class="column col-12 col-md-6 q-py-none">
                    ...
                    <div class="col-auto q-mt-lg self-end">
                      <q-btn
                        :loading="isLoading && !patientTaxCode"
                        color="primary"
                        outline
                        type="submit"
                      >
        ...
        <div v-if="isFirstPiedmontSearch" class="q-mt-lg q-pt-md">
          ...
          <div v-if="isLoading" class="row items-stretch q-col-gutter-lg">
            <div v-for="i in 4" :key="i" class="col-12 col-md-6 self-stretch">
          ...
          <template v-else>
            ...
            <div v-else class="row items-stretch q-col-gutter-lg">
              <div
                ...
                :key="patient.codice_fiscale"
                class="col-12 col-md-6 self-stretch"
              >
                <fse-patient-piedmont-item :patient="patient" />
              </div>
            </div>
          </template>
        </div>
      ...
      <q-tab-panel :name="TABS.EXTRA_REGION">
            ...
            <div class="row items-center q-col-gutter-md full-width">
              ...
              <div class="q-mt-md col-12 col-md-auto text-right">
                <q-btn
                  ...
                  color="primary"
                  outline
                  @click="onSearchPatientExtraRegion"
                >
                  Cerca
                </q-btn>
              </div>
        ...
        <div v-if="isFirstExtraRegionSearch" class="q-mt-lg q-pt-md">
          ...
          <template v-else>
            ...
            <div class="text-h6 q-my-lg">Risultati della ricerca</div>
            <div
              v-if="patientExtraRegion"
              class="row items-stretch q-col-gutter-lg"
            >
              <div class="col-12 col-md-6 self-stretch">
                <template v-if="isPatientPiedmont">
                  <fse-patient-piedmont-item :patient="patientExtraRegion" />
                </template>
                <template v-else>
...
export default {
  ...
  components: {
    FsePatientPiedmontItemSkeleton,
    FsePatientExtraRegionItem,
    FsePatientPiedmontItem,
  },
  props: {},
  data() {
    return {
  ...
  methods: {
    ...
    async onSearchPatientPiedmont(params) {
      ...
      try {
        ...
        let message = "Non è stato possibile recuperare la lista dei pazienti.";
    ...
    async onSearchPatientExtraRegion() {
      ...
      this.consents = await this.$store.dispatch(
        "getPatientConsents",
        this.patientTaxCode
      );
      ...
      if (
        this.consents?.identificativo_informativa_corrente?.indexOf("010") === 0
      ) {
        try {
          ...
          let message =
            "Non è stato possibile recuperare le informazioni del pazienti.";
          apiErrorNotify({ error, message });
        }
      }
