      ...
      <div>
        ...
        <template v-if="hasNreAssociated">
          <a
            ...
            href="#"
            @click.prevent="
              onSearchAssociated(ASSOCIATION_OPERATION_TYPE_MAP.NRE)
            "
          >
            Mostra correlati
          </a>
      ...
      <div>
        ...
        <template>
          <a
            ...
            href="#"
            @click.prevent="
              onSearchAssociated(ASSOCIATION_OPERATION_TYPE_MAP.EPISODE_PS)
            "
          >
            Mostra correlati
          </a>
      ...
      <div>
        ...
        <template>
          <a
            ...
            href="#"
            @click.prevent="
              onSearchAssociated(ASSOCIATION_OPERATION_TYPE_MAP.EPISODE_SDO)
            "
          >
            Mostra correlati
          </a>
