  ...
  <csi-page class="page-screening-detail" padding>
    ...
    <div class="row justify-center items-center q-gutter-lg">
          ...
          <div class="row q-col-gutter-lg items-start">
            ...
            <q-item class="col-12 col-md-4">
              <q-item-section>
                ...
                <q-item-label :class="screeningResultColor" class="text-bold"
                  >{{ screeningResult | upperCase | empty }}
                </q-item-label>
              </q-item-section>
            </q-item>
      ...
      <q-card class="col-12 col-md-10">
        ...
        <q-card-section
          v-for="(diagnosticJudgment, index) in diagnosticJudgments"
          :key="index"
        >
          <div class="row q-col-gutter-lg items-start">
            <q-item class="col-12 col-md-4">
              <q-item-section>
                <q-item-label caption class="text-black"
                  >Prestazioni</q-item-label
                >
                <q-item-label
                  v-for="service in diagnosticJudgment.prestazioni"
                  :key="service.codice"
                  class="text-bold"
                >
            ...
            <q-item class="col-12 col-md-4">
              <q-item-section>
                ...
                <q-item-label
                  class="text-bold"
                  v-if="diagnosticJudgment.giudizio"
                  >{{
                    diagnosticJudgment.giudizio.descrizione | empty
                  }}</q-item-label
                >
              </q-item-section>
            </q-item>
            ...
            <q-item class="col-12 col-md-4">
              <q-item-section>
                ...
                <q-item-label
                  class="text-bold"
                  v-for="(doctor, index) in diagnosticJudgment.medici"
                  :key="index"
                  >{{ doctor.nome | empty }} ({{
                    doctor.figura_professionale | empty
                  }})</q-item-label
                >
              </q-item-section>
            </q-item>
          ...
          <div class="row q-col-gutter-lg items-start">
            ...
            <q-item class="col-12 col-md-4">
              <q-item-section>
                ...
                <q-item-label
                  class="text-bold"
                  v-for="(doctor, index) in finalIndicationDoctors"
                  :key="index"
                >
        ...
        <q-card-section>
          <div class="row q-col-gutter-lg items-start">
            ...
            <q-item class="col-12 col-md-6">
              <q-item-section>
                <q-item-label caption class="text-black"
                  >Struttura sanitaria</q-item-label
                >
                <q-item-label class="text-bold">
...
export default {
  ...
  computed: {
    ...
    screeningResultColor() {
      let color = "";
      if (equalsIgnoreCase(this.screeningResult, SCREENING_RESULT_MAP.POSITIVE))
        color = "text-red-7";
      else if (
        equalsIgnoreCase(this.screeningResult, SCREENING_RESULT_MAP.NEGATIVE)
      )
        color = "text-green-7";
  ...
  created() {
    ...
    (this.screeningType = screeningType), (this.screening = screening);
  },
  methods: {},
};
</script>
