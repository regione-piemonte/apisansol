...
<template>
  <csi-page padding>
    <div class="column q-gutter-md">
      ...
      <template v-else>
        <csi-banner type="info"> Nessuno screening trovato </csi-banner>
      </template>
    </div>
  </csi-page>
</template>
...
} from "src/services/screening/config";
...
export default {
  ...
  async created() {
    ...
    try {
      ...
      let message = "Non è stato possibile recuperare la lista degli screening";
