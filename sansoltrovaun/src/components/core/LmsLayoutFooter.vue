...
<template>
  <q-footer v-bind="attrs" v-on="listeners" class="lms-layout-footer">
    ...
    <!-- ----------------------------------------------------------------------------------------------------------- -->
    <div class="lms-trova-un-footer">
      <div class="lms-trova-un-footer__waves"
           style="background-image : url('/statics/la-mia-salute/immagini/sfondo-footer.svg')">
        <div class="lms-trova-un-footer__banner"
             style="background-image : url('images/trova-un-footer-banner.svg')"></div>
      </div>
    </div>
...
.lms-trova-un-footer__waves
  background-repeat: no-repeat
  background-position: center top
  background-size: auto
  min-height: 400px

.lms-trova-un-footer__banner
  background-repeat: no-repeat
  background-position: center top
