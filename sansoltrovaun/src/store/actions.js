...
export const setActiveService = (context, { service }) => {
  context.commit("SET_ACTIVE_SERVICE", { service });
};


export const setDoctorTypes = (context, { types }) => {
  context.commit("SET_DOCTOR_TYPES", { types });
};

export const setFacilitiesTypes = (context, { types }) => {
  context.commit("SET_FACILITIES_TYPES", { types });
};

export const setHospitalsTypes = (context, { types }) => {
  context.commit("SET_HOSPITALS_TYPES", { types });
};

export const setCeliacStoresTypes = (context, { types }) => {
  context.commit("SET_CELIAC_STORES_TYPES", { types });
};

export const setResultsOnMap = (context,  value ) => {
  context.commit("SET_RESULTS_ON_MAP", value );
};

export const setIfFirstAccess = (context,  value ) => {
  context.commit("SET_IF_FIRST_ACCESS", value );
};
