...
<template>
  <q-page padding>
    <csi-page-title title="Esenzione rettificata"/>

    <template v-if="exemption && !isLoading">
      <q-alert color="positive" class="q-mt-lg q-mx-md">
        <div class="q-display-2 text-weight-bold">
          La rettifica dell'esenzione è stata compilata correttamente. <br>

          Numero pratica {{exemption.numero_pratica}}. Correzione richiesta il {{today | format}}
        </div>
