...
<template functional>
  <g class="csi-icon-menu-prescription">
    ...
    <g id="Livello_2">
      <g id="icons">
        ...
        <rect x="17" y="25.9" transform="matrix(0.7876 -0.6162 0.6162 0.7876 -11.1945 20.8774)" class="st0" width="15.3"
              height="1.6" />

        <rect x="16.2" y="10.4" transform="matrix(0.7071 -0.7071 0.7071 0.7071 -6.9012 16.9125)" class="st0" width="1.6"
              height="12.8" />
