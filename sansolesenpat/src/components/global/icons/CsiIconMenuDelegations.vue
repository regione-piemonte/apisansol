...
<style scoped lang="stylus">
  ...
  $map = {
    primary: {st0: $primary, st1: white},
    secondary: {st0: $secondary, st1: white},
    tertiary: {st0: $tertiary, st1: white},
    positive: {st0: $positive, st1: white},
    negative: {st0: $negative, st1: white},
    warning: {st0: $warning, st1: white},
  }
  */
  ...
  /*
  for $class, $subclasses in $map
    .csi-icon-menu-delegations.{$class}
      .st0
        fill: $subclasses.st0
