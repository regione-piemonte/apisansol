                ...
                <div class="text-body1">
                  <p>
                    ...
                    <span class="text-bold">
                      {{ mobilePhone | trimLeft(MOBILE_PHONE_PREFIX_ITALY) }}
                    </span>
                    .
                  </p>
...
export default {
  ...
  methods: {
    onInputPhone(val){
      this.mobilePhone= MOBILE_PHONE_PREFIX_ITALY + val
    },
    onStepNext() {
      this.step += 1;
    },
