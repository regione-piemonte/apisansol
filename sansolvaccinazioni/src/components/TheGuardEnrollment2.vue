...
<!--      </q-banner>-->
    ...
    <template v-if="['007'].includes(code)">
      <q-banner class="bg-yellow-2" rounded>
        ...
        <div class="text-body1">
          Colui che ti ha delegato non ha il Fascicolo Sanitario Elettronico attivo, pertanto non potrai scaricare il Certificato dei vaccini effettuati
        </div>
      </q-banner>
    </template>
    ...
    <template v-if="['010'].includes(code)">
      <q-banner class="bg-yellow-2" rounded>
        ...
        <div class="text-body1">
          ...
          nuovamente attivare il fascicolo e prendere visione della nuova informativa e risottomettere i consensi.<br>
          Se non viene effettuata questa operazione non sarà possibile scaricare il Certificato dei vaccini effettuati.
    ...
    <template v-else-if="['011'].includes(code)">
      <q-banner class="bg-yellow-2" rounded>
        ...
        <div class="text-body1">
          &Egrave; stata cambiata l’informativa: colui che ti ha delegato deve prenderne visione e confermare i consensi dati.<br>
          Se non viene effettuata questa operazione non sarà possibile scaricare il Certificato dei vaccini effettuati.
        </div>
      </q-banner>
    </template>
    ...
    <template v-if="['012'].includes(code)">
      <q-banner class="bg-yellow-2" rounded>
        ...
        <div class="text-body1">
          ...
          di assistenza è stato completato. Per proseguire con la navigazione, aggiorna la pagina premendo F5.
        </div>
