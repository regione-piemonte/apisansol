...
<template>
  <q-dialog
    ...
    v-on="listeners"
  >
    <q-card class="onboarding-dialog full-height"
            :class="{'minWidth' : $q.screen.gt.xs}">
      <q-card-section class="no-padding full-height  ">
        ...
        >
          <q-carousel-slide
            class="no-padding"
            :class="{'overflow-hidden-y': $q.screen.gt.md}"
            ...
            >
              ...
              <div class="column no-wrap onboarding-dialog__slide q-pa-md relative-position">
                ...
                <div class="text-center q-mb-sm">
                  <img class="onboarding-dialog__logo-salute-piemonte"
                       src="/statics/la-mia-salute/immagini/logo-la-mia-salute-blu.svg" alt="">
                </div>
                <!--navigation-->
                ...
                <div class="text-center q-pt-xl relative-position">
                  ...
                  <img :src="slideImage(index)" style="height: 150px">
                  <!--avanti-->
                ...
                <div class="text-center q-mt-md ">
                  <img class="onboarding-dialog__logo-regione-piemonte"
                       src="/statics/la-mia-salute/immagini/logo-regione-piemonte.svg" alt="">
                </div>
...
export default {
  ...
  methods: {
    ...
    slideImage(index) {
      return 'images/' + ONBOARDING_LIST_ITEMS[index]?.icon + '.svg'
    },
    previousSlice() {
...
.onboarding-dialog__slide
  height: auto
  min-height: 100%
  background: url(../../public/images/onboarding-sfondo.svg) left -225px top -65px/1200px no-repeat
  @media (max-width: $breakpoint-xs-max)
    &
      min-height: 100vh
      background: url(../../public/images/onboarding-sfondo-mobile.svg) left -225px top 0px/1000px no-repeat !important
