  ...
  <q-layout class="lms-layout-app" view="hHh lpr fff">
    ...
    <q-page-container>
      ...
      <template v-else>
        ...
        <div class="container" style="min-width: 562px">
          <div class=" text-right q-mt-lg layout-padding q-page lms-page">

            <a
              target="_blank"
              href="url"
              class="text-italic  lms-link " >Privacy e condizioni d'uso
            </a>
          </div>
        </div>
