...
const LOG = true;
define('LOG_ROOT', implode(DIRECTORY_SEPARATOR, [PATH_PROJECT_ROOT, 'logs']));
...
const PTW = [
    'ASR_LIST' => [
        ...
        ['id' => 213, 'nuovo' => true, 'nre_attivo' => false, 'descrizione' => 'ASL AL (Alessandria)', 'tipologia' => 'ASL',  'gruppo_id' => null],
        [
            'id' => 301,
            'nuovo' => true,
            'nre_attivo' => false,
