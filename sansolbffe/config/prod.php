...
// tst-sansol ci serve per poter usare dei tool di utility hostati su test
...
const APISANESENRED_USER = 'user_sansol';
...
const NOTIFY_PREFERENCES_SCHEME = 'http';
const NOTIFY_PREFERENCES_HOST = 'HOST';
const NOTIFY_PREFERENCES_PORT = null;

const NOTIFY_MESSAGE_STORE_SCHEME = 'http';
...
const PTW = [
    'ASR_LIST' => [
        ...
        ['id' => 207, 'nuovo' => true, 'nre_attivo' => false, 'descrizione' => 'ASL BI (Biella)', 'tipologia' => 'ASL'],
        ...
        ['id' => 213, 'nuovo' => true, 'nre_attivo' => false, 'descrizione' => 'ASL AL (Alessandria)',
            'tipologia' => 'ASL'],
        [
            'id' => 301,
            'nuovo' => true,
