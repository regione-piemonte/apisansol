...
export const setAssistanceConfiguration = (context, { configuration }) => {
  context.commit("SET_ASSISTANCE_CONFIGURATION", { configuration });
};
...
export const setAsrList = (context, asrList ) => {
  context.commit("SET_ASR_LIST",  asrList );
};
