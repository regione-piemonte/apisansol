...
<template>
  <q-footer v-bind="attrs" v-on="listeners" class="lms-layout-footer">
    <div class="row  justify-end q-my-lg q-mx-lg" v-if="policy">
      <a href="#" @click.prevent="openPolicyDialog" class="lms-link">
    ...
    <div class="lms-footer-illustration">
      <div class="lms-footer-illustration__waves" style="background-image : url('/statics/la-mia-salute/immagini/sfondo-footer.svg')">
...
export default {
  ...
  components: {LmsPrivacyPolicyDialog},
  inheritAttrs: false,
  props: {
...
<style lang="sass">
  ...
  .lms-footer-illustration__banner
    background-image: url('../../../public/images/assistenza-footer-banner.svg')
    background-repeat: no-repeat
    background-position: center top
