...
<template>
  <div class="lms-the-guard-enrollment-2 relative-position">
<!--    <div class="absolute-top-right q-pa-xs">-->
<!--      <q-btn v-close-popup flat round icon="close" dense  aria-label="chiudi finestra" @click="$emit('hide-banner')"/>-->
<!--    </div>-->

    <template v-if="['000', '004'].includes(code)">
      <q-banner class="bg-yellow-2" rounded>
        ...
        <div class="text-body1">
          <p>
            Attenzione! <br>
            Per poter utilizzare questo servizio è necessario il <strong>consenso all’alimentazione dei dati contenuti
            nel tuo Fascicolo Sanitario Elettronico</strong>.
          </p>
    ...
    <template v-if="['001', '002', '018'].includes(code)">
      <q-banner class="bg-yellow-2" rounded>
        <template #avatar>
          <q-icon name="fas fa-exclamation-triangle" size="sm"/>
        </template>
        ...
        <div class="text-body1">
          <p>
            Attenzione!<br>
            Per poter utilizzare questo servizio è necessario avere come regione di assistenza il Piemonte.
          </p>
          <p>
            Puoi utilizzare il servizio solo come delegato di un cittadino assistito in Piemonte.
          </p>
    ...
    <template v-else-if="['005'].includes(code)">
      <q-banner class="bg-yellow-2" rounded>
        ...
        <div class="text-body1">
          Attenzione!<br>
          Per poter utilizzare questo servizio è necessario il <strong>consenso all’alimentazione dei dati presenti nel
          tuo Fascicolo Sanitario Elettronico</strong>.
    ...
    <template v-if="['007'].includes(code)">
      <q-banner class="bg-yellow-2" rounded>
        ...
        <div class="text-body1">
          <p>
            Attenzione!<br>
            Per poter utilizzare questo servizio è necessario il <strong>consenso all’alimentazione dei dati presenti
            nel
            tuo Fascicolo Sanitario Elettronico</strong>.
          </p>
          <p>
            Se stai accedendo per conto di una persona che ti ha delegato, ricorda <strong>che in assenza del suo
            consenso non sei abilitato all’uso del servizio</strong>.
          </p>
    ...
    <template v-else-if="['008'].includes(code)">
      <q-banner class="bg-yellow-2" rounded>
        ...
        <div class="text-body1">
          <p>
            Attenzione!<br>
            Per utilizzare questo servizio è necessario il consenso alla consultazione del tuo Fascicolo Sanitario
            Elettronico.
          </p>
          <p>
            Puoi visualizzare solo le conversazioni ed i relativi messaggi già inviati!
          </p>
    ...
    <template v-else-if="['009'].includes(code)">
      <q-banner class="bg-yellow-2" rounded>
        ...
        <div class="text-body1">
          ...
          <p>
            Se stai accedendo per conto di una persona che ti ha delegato, ricorda <strong>che in assenza del suo
            consenso non sei abilitato a tutte le funzionalità del servizio</strong>.
          </p>
        </div>
    ...
    <template v-if="['010'].includes(code)">
      <q-banner class="bg-yellow-2" rounded>
        ...
        <div class="text-body1">
          <p>
            Attenzione!<br>
            Per utilizzare questo servizio è necessario prendere <strong>visione della versione aggiornata
    ...
    <template v-else-if="['015'].includes(code)">
      <q-banner class="bg-yellow-2" rounded>
        ...
        <div class="text-body1">
          <p>
            Attenzione!<br>
            Il servizio è <strong>riservato agli assistiti dalla Regione Piemonte</strong>.</p>
        </div>
    ...
    <template v-if="['994'].includes(code)">
      <q-banner class="bg-yellow-2" rounded>
        ...
        <div class="text-body1">
          Non è possibile accedere al servizio perché il codice fiscale è stato annullato
        </div>
      </q-banner>
    </template>
    ...
    <template v-if="['995'].includes(code)">
      <q-banner class="bg-yellow-2" rounded>
        ...
        <div class="text-body1">
          Non è possibile accedere al servizio perché l'assistito è emigrato
        </div>
      </q-banner>
    </template>
    ...
    <template v-if="['996'].includes(code)">
      <q-banner class="bg-yellow-2" rounded>
        ...
        <div class="text-body1">
          Non è possibile accedere al servizio perché l'assistito è deceduto
        </div>
      </q-banner>
    </template>
    ...
    <template v-if="['997'].includes(code)">
      <q-banner class="bg-yellow-2" rounded>
        ...
        <div class="text-body1">
          Non è possibile accedere al servizio per mancata corrispondenza patient Id
        </div>
      </q-banner>
    </template>
    ...
    <template v-if="['998'].includes(code)">
      <q-banner class="bg-yellow-2" rounded>
        ...
        <div class="text-body1">
          Non è possibile accedere al servizio perchè l'identificativo assistito non valido
        </div>
      </q-banner>
    </template>
    ...
    <template v-if="['999'].includes(code)">
      <q-banner class="bg-yellow-2" rounded>
        ...
        <div class="text-body1">
          Non è possibile accedere al servizio per altro errore di stato consensi
        </div>
      </q-banner>
    </template>
  </div>
...
export default {
  ...
  computed: {
    ...
    app() {
      return this.appList?.find(a => a.codice === APPLICATION_CODE);
    },
    ...
    enrollmentUrl() {
      return "/la-mia-salute/arruolamento/#/?servizio=SERVICE";
    },
    enrollmentUrlDelegator() {
      let url = "/la-mia-salute/arruolamento/#/?servizio=SERVICE";
  ...
  methods: {
    onActivate() {
      const url = "/la-mia-salute/arruolamento/#/?servizio=SERVICE";
