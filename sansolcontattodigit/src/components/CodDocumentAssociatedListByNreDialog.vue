...
<template>
  <q-dialog
    v-bind="attrs"
    v-on="listeners"
    class="fse-associate-list-by-nre-dialog"
  >
    <q-card style="max-width: 800px">
      <q-toolbar>
        <q-toolbar-title>
          Documenti associati per Numero di Ricetta Elettronica
        </q-toolbar-title>
      ...
      <q-card-section class="q-gutter-y-md">
        <cod-document-item
          ...
          :key="'nre-association--' + document.id_documento_ilec"
          :document="document"
        />
      </q-card-section>
    </q-card>
