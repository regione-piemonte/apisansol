...
export default {
  ...
  methods: {
    ...
    onFocusCheckbox( event){
      console.log('onFocusCheckbox',event)
      let parent = event.target.parentElement
...
.hol-icon:before{
  color: #fff;
  margin-top: 8px;
  content: url(https://tst-niv-sansol.isan.csi.it/statics/la-mia-salute/icone/check_box_selected.svg);
}
