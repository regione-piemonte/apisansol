...
<template functional>
  <g id="Livello_2" class="csi-icon-menu-health-payments">
    <g id="icon">
      <rect x="32.8" y="15.5" transform="matrix(0.1778 -0.9841 0.9841 0.1778 8.7666 48.7017)" class="st0" width="1.4"
            height="7.2" />
      <rect x="32.9" y="12.2" transform="matrix(0.1778 -0.9841 0.9841 0.1778 11.6338 46.3976)" class="st0" width="1.4"
            height="8" />
      <rect x="18.1" y="5.1" transform="matrix(0.1778 -0.9841 0.9841 0.1778 2.066 29.6797)" class="st0" width="1.4"
            height="17.1" />
...
<script>
  export default {
    name: "CsiIconMenuHealthPayments"
  }
</script>
