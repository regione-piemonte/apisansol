  ...
  <q-page class="home-page-home overflow-hidden" :class="classes">
    ...
    <template v-if="$q.screen.lt.lg">
      ...
      <template v-if="!user">
        ...
        <div class="q-py-md" />
        <home-application-list-widget class="q-pa-md" />
        <!--        <div class="q-py-md" />-->
        <lms-buttons class="q-pa-md">
          <lms-button @click="onLogin"> Accedi a tutti i servizi</lms-button>
        </lms-buttons>
      ...
      <template v-else>
        ...
        >
          ...
          <template v-if="!isUserInfoErrorTimeout">
      ...
      <div class="q-px-md q-pt-md" style="max-width: 1440px; margin: auto">
        ...
        <template v-if="!user">
          <div class="row q-col-gutter-xl">
            ...
            <div class="col-12 col-lg-6 ">
              <div class="q-py-sm" />
              <!--            NASCONDO LA PARTE DI MESSAGGI A SIMON PER EVITARE ALERT-->
              ...
              <lms-buttons class=" q-mt-md">
                <lms-button @click="onLogin">
                  Accedi a tutti i servizi</lms-button
                >
              </lms-buttons>
              <div class="q-py-xl" />
              <home-find-a-widget />
...
import HomeApplicationListWidget from "../components/HomeApplicationListWidget";
...
import {MONITORING_CF} from "../services/config";
...
export default {
  ...
  computed: {
    ...
    isUserInfoErrorTimeout() {
      return this.$store.getters["isUserInfoErrorTimeout"];
    },
      //SE UTILIZZO LA URL SPECIFICA OPPURE HO IL CF DI MONITORAGGIO SIMON, ALLORA NASCONDO I MESSAGGI
      isSimon() {
        if(this.isSimonUrl===true || this.user?.cf===MONITORING_CF.SIMON){
            return true
        }
        return false
      },
  ...
  async created() {
    //CONTROLLO SE LA URL è CHIAMATA DA MONITORAGGIO SIMON
    if (this.$route.query?.isSimon === "true") {
      this.isSimonUrl = true;
    }
