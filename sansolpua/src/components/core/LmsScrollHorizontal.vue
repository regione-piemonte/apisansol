        ...
        >
          <template v-if="!controlsFloating || !isLeftEdge">
            <q-btn
              ...
              flat
              dense
              class="lms-scroll-horizontal-control__button lms-scroll-horizontal-control__button-left"
              :disable="isLeftEdge"
              aria-hidden="true"
            >
              <q-icon
        ...
        >
          <template v-if="!controlsFloating || !isRightEdge">
            <q-btn
              ...
              flat
              dense
              class="lms-scroll-horizontal-control__button lms-scroll-horizontal-control__button-right"
              :disable="isRightEdge"
              aria-hidden="true"
            >
              <q-icon
  ...
  computed: {
    rootClasses() {
      ...
      if (this.controlsInvisibleOnThreshold) {
        result.push("lms-scroll-horizontal--controls-invisible");
      }

      if (this.isLeftEdge) {
        result.push("lms-scroll-horizontal--left-edge");
      }

      if (this.isRightEdge) {
        result.push("lms-scroll-horizontal--right-edge");
      }
...
.lms-scroll-horizontal--controls-invisible.lms-scroll-horizontal--left-edge
  .lms-scroll-horizontal-control__button-left
    visibility: hidden

.lms-scroll-horizontal--controls-invisible.lms-scroll-horizontal--right-edge
  .lms-scroll-horizontal-control__button-right
    visibility: hidden
