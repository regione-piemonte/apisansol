  ...
  <div class="home-application-list-widget">
    ...
    <div class="row items-center">
      ...
      <div class="col-auto" v-if="$q.screen.gt.sm">
        <router-link :to="APP_LIST_NEW" class="lms-link q-mr-lg">
          Vedi tutti
        </router-link>
      </div>
    </div>
    ...
    <!-- ----------------------------------------------------------------------------------------------------------- -->
    <div class="q-mt-md">
      <q-scroll-area  visible  style="height: 400px"  :thumb-style="thumbStyle">
      <transition-group name="app-list" tag="div" class="row q-col-gutter-md full-heigh q-mr-md">
        <div
        ...
        >
          ...
          <template v-else-if="isLocked(app)">
            <home-application-list-item
              :app="app"
              :anonymous="!user"
              :favorite="app.__favorite"
      ...
      <lms-buttons class="q-mt-md" v-if="$q.screen.lt.md">
        <lms-button outline :to="APP_LIST_NEW">Vedi tutti</lms-button>
      </lms-buttons>
