...
<template>
  <q-footer v-bind="attrs" v-on="listeners" class="lms-layout-footer">
    ...
    <div class="row  justify-end q-my-xl q-mx-lg" v-if="showPrivacyLink">
    ...
    <!-- ----------------------------------------------------------------------------------------------------------- -->
    <div class="lms-celiachia-footer">
      <div class="lms-celiachia-footer__waves"
           style="background-image : url('/statics/la-mia-salute/immagini/sfondo-footer.svg')">
        <div class="lms-celiachia-footer__banner"
             style="background-image : url('images/celiachia-footer-banner.svg')"></div>
      </div>
    </div>
    <!-- RATING -->
    <!-- ----------------------------------------------------------------------------------------------------------- -->
    ...
    <div class="bg-blue-10 q-px-sm">
      ...
      >
        <div class="col-12 col-sm-auto">
          <a href="URL">
            <img src="/statics/la-mia-salute/immagini/logo-piemonte-tu.svg" alt="Logo Piemonte Tu" class="responsive"
...
import {PRIVACY_POLICY} from "src/router/routes";
...
.lms-celiachia-footer
  width: 100%
  margin-top: 16px
  margin-bottom: -3px

.lms-celiachia-footer__waves
  background-repeat: no-repeat
  background-position: center top
  background-size: auto
  min-height: 400px

.lms-celiachia-footer__banner
  background-repeat: no-repeat
  background-position: center top
