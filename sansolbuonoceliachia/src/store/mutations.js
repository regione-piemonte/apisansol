...
export const SET_NEW_PIN = (state, pin) => {
  state.currentPin = pin;
};
export const SET_CURRENT_PAYSLIP = (state, { payslip }) => {
  state.currentPayslip = payslip;
};
export const SET_PAYSLIP_ERR_MESSAGE = (state, { message }) => {
  state.payslipErrMessage = message;
};
