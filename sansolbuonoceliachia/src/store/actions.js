...
export const setNewPin= (context,  pin ) => {
  context.commit("SET_NEW_PIN", pin );
};

export const setCurrentPayslip= (context,  {payslip} ) => {
  context.commit("SET_CURRENT_PAYSLIP", {payslip} );
};
export const setPayslipErrMessage= (context,  {message} ) => {
  context.commit("SET_PAYSLIP_ERR_MESSAGE", {message} );
};
